...
<body>
  <div class="container">
    ...
    <div class="bg-white rounded-lg shadow-md p-4">
        <h5 class="text-lg font-semibold mb-4">Liste des demandes de mutation</h5>
            ...
            <table class="w-full table-auto">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-4 py-2">nombre_annees_travaillees</th>
                ...
                <tbody>
                @foreach($demandeMutations as $demande)
                    <tr class="border-b border-gray-200">
                        <td class="px-4 py-2">{{ $demande->matricule }}</td>
                        <td class="px-4 py-2">{{ $demande->motif }}</td>
                        <td class="px-4 py-2">{{ $demande->nombre_annees_travaillees }}</td>
                        <td class="px-4 py-2">{{ $demande-> direction}}</td>
                        <td class="px-4 py-2">{{ $demande->statut }}</td>
                        <td class="px-4 py-2">
                        <form action="{{ route('demandemutation.accept', $demande) }}" method="post">
    @csrf
    <button type="submit" class="bg-green-500 text-white rounded-full p-2 hover:bg-green-600">
        <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            <path d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-1-6.41l-3.29-3.3 1.42-1.42L9 9.58l4.29-4.3 1.42 1.42-5 5z" />
        </svg>
    </button>
</form>
<form action="{{ route('demandemutation.refuse', $demande) }}" method="post">
    @csrf
