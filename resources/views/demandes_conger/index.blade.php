...
<body>
  <div class="container">
    ...
    <div class="bg-white rounded-lg shadow-md p-4">
        <h5 class="text-lg font-semibold mb-4">Liste des demandes de congé</h5>
            ...
            <table class="w-full table-auto">
                ...
                @foreach($demandesConge as $demande)
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="px-4 py-2">
                        <form action="{{ route('demandes_conger.accept', $demande) }}" method="post">
    @csrf
...
<form action="{{ route('demandes_conger.refuse', $demande) }}" method="post">
    @csrf
