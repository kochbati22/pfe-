    ...
    <div class="row">
      <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
        <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
          <h3 class="m-0">Welcome to poste tunusienne </h3>
          <img class="img-fluid rounded mx-auto my-4" loading="lazy" src="https://idaraty.s3.us-west-000.backblazeb2.com/logos/office-nationale-des-postes.png" width="245" height="80" alt="BootstrapBrain Logo">
          ...
          @if(session('error'))
            ...
            <div class="row gy-3 gy-md-4 overflow-hidden">
              <div class="col-12">
                ...
                <input type="matricule" class="form-control" name="matricule" id="matricule" placeholder="" required>
              </div>
              <div class="col-12">
